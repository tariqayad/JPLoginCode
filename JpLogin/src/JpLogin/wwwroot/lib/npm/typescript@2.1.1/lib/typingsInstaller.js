  ...
  (function(ts) {
    ts.Diagnostics = {
      ...
      The_path_in_an_extends_options_must_be_relative_or_rooted: {
        code: 18001,
        category: ts.DiagnosticCategory.Error,
        key: "The_path_in_an_extends_options_must_be_relative_or_rooted_18001",
        message: "The path in an 'extends' options must be relative or rooted."
      },
  ...
  (function(ts) {
    ...
    function resolveTypeReferenceDirective(typeReferenceDirectiveName, containingFile, options, host) {
      ...
      if (typeRoots && typeRoots.length) {
        ...
        for (var _i = 0,
            primarySearchPaths_1 = primarySearchPaths; _i < primarySearchPaths_1.length; _i++) {
          ...
          if (resolvedFile_1) {
            ...
            return {
              resolvedTypeReferenceDirective: {
                primary: true,
                resolvedFileName: resolvedFile_1
              },
              failedLookupLocations: failedLookupLocations
            };
          }
    ...
    function classicNameResolver(moduleName, containingFile, compilerOptions, host) {
      ...
      if (moduleHasNonRelativeName(moduleName)) {
        referencedSourceFile = referencedSourceFile = loadModuleFromAncestorDirectories(moduleName, containingDirectory, supportedExtensions, failedLookupLocations, state) || loadModuleFromNodeModulesAtTypes(moduleName, containingDirectory, failedLookupLocations, state);
      } else {
        var candidate = ts.normalizePath(ts.combinePaths(containingDirectory, moduleName));
        ...
        var TypingsInstaller = (function() {
          ...
          TypingsInstaller.prototype.installTypings = function(req, cachePath, currentlyCachedTypings, typingsToInstall) {
            ...
            this.installTypingsAsync(requestId, scopedTypings, cachePath, function(ok) {
              ...
              for (var _i = 0,
                  scopedTypings_1 = scopedTypings; _i < scopedTypings_1.length; _i++) {
      ...
      (function(typingsInstaller) {
        ...
        var NodeTypingsInstaller = (function(_super) {
          ...
          function NodeTypingsInstaller(globalTypingsCacheLocation, throttleLimit, telemetryEnabled, log) {
            ...
            var execSync;
            (_a = require('@empty'), _this.exec = _a.exec, execSync = _a.execSync, _a);
            ...
            try {
              ...
              execSync(_this.npmPath + " install " + TypesRegistryPackageName, {
